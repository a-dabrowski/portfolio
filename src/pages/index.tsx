...
import { FileQueryNode } from '../types';

interface StartPageData {
  zamoyskichNadia: FileQueryNode;
  zamoyskichKlaudia: FileQueryNode;
  bemaAnna: FileQueryNode;
  bemaWiktoria: FileQueryNode;
  paulina: FileQueryNode;
  balkan: FileQueryNode;
  studioFriends: FileQueryNode;
  milena: FileQueryNode;
  milenaNeon: FileQueryNode;
}

const PhotographyIndex = ({ data, location }: PageProps<StartPageData>) => (
