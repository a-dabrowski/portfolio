...
import { ProjectData, StackItem } from '../types';
...
const PhotographyIndex = ({ location }: PageProps) => {
  return (
      ...
      <div>
        ...
        <main>
          <section id="projects">
            ...
            <ul className="list">
              {ProjectsJSON.projects.map((el: ProjectData) => (
                <Project data={el} />
              ))}
            </ul>
          </section>
          <section id="technologies">
            ...
            <ul className="carousel">
              {StackJSON.stack.map((el: StackItem) => (
                <li>
                  <Technology
                    name={el.name}
                    fill={el.fill}
