...
const FortBemaAnnaPhotography = ({ data, location }) => {
  return (
...
export const FortBemaAnnaQuery = graphql`query AnnaFortBema {
  allFile(
    filter: {extension: {eq: "jpg"}, sourceInstanceName: {eq: "photography"}, relativeDirectory: {eq: "fort_bema_anna"}}
  ) {
    edges {
      node {
        id
