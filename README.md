...
Remove `node_modules` and `package-lock.json`. Make sure that you are running Node version specified in `.nvmrc` or `.tool-versions`. Then reinstall packages with `npm i --legacy-peer-deps`.
